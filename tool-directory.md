...
| `expand_copper_layers` | Expand an open board to an even copper layer count, preserving existing layers. Live IPC only; dry-run default, expected-count guard and readback verification. Removal is unsupported. |
