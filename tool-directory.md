...
| `edit_footprint_fabrication` | Inspect or revision-check live footprint mounting style and symmetric pad paste overrides; exact physical-pad count, one undo commit, full readback, no file fallback. |
