...
| `promote_embedded_symbols` | Copy selected embedded schematic symbols to a new project-local library, qualify their IDs and optionally correct electrical pin types. Requires a dry-run revision for apply; preserves drawing and pin geometry. |
